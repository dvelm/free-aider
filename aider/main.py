...
def main(argv=None, input=None, output=None, force_git_root=None):
    ...
    core_group.add_argument(
        "--model",
        metavar="MODEL",
        default=models.GPT35.name,
        help=f"Specify the model to use for the main chat (default: {models.GPT35.name})",
    )
    core_group.add_argument(
        "-3",
        action="store_const",
    ...
    model_group.add_argument(
        ...
        default="https://api.chatanywhere.cn/v1", 
    help="Specify the openai.api_base (default: https://api.chatanywhere.cn/v1)",
)
    model_group.add_argument(
        "--openai-api-type",
